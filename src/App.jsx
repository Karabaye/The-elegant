...
import marvel1 from "../src/assets/images/1.jpg";
import marvel2 from "../src/assets/images/2.jpg";
import marvel3 from "../src/assets/images/18.jpg";
import marvel4 from "../src/assets/images/14.jpg";
import logo from "../src/assets/images/logo.jpg";

const images = [marvel1, marvel2, marvel3, marvel4];
  ...
  return (
    <div className="relative w-full h-screen bg-black overflow-hidden font-poppins">
      ...
      <div className="carousel h-full w-full overflow-hidden relative">
        {/* Background Image */}
        <div className="absolute w-full h-full bg-cover bg-center transition-all duration-700 ease-in-out" style={{ backgroundImage: `url(${images[indexSelect]})` }}></div>
